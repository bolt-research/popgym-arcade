...
# python popgym_arcade/train.py PQN_RNN --MEMORY_TYPE "mingru" --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 1
# python popgym_arcade/train.py PQN_RNN --MEMORY_TYPE "mingru" --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 2
# python popgym_arcade/train.py PQN_RNN --MEMORY_TYPE "mingru" --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 1 --PARTIAL
# python popgym_arcade/train.py PQN_RNN --MEMORY_TYPE "mingru" --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 2 --PARTIAL

# python popgym_arcade/train.py PQN_RNN --MEMORY_TYPE "mingru" --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 6
python popgym_arcade/train.py PQN_RNN --MEMORY_TYPE "mingru" --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 8
python popgym_arcade/train.py PQN_RNN --MEMORY_TYPE "mingru" --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 6 --PARTIAL
python popgym_arcade/train.py PQN_RNN --MEMORY_TYPE "mingru" --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 8 --PARTIAL
python popgym_arcade/train.py PQN --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 0
python popgym_arcade/train.py PQN --ENV_NAME "BattleShipEasy" --TOTAL_TIMESTEPS 20000000 --TOTAL_TIMESTEPS_DECAY 2000000 --NUM_LAYERS 0 --PARTIAL
