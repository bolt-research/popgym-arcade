...
def plot_summary(saliency_dir: str, output_path: str, dpi: int = 300):
    # Prepare data [num_envs, 2, 3]
...
def main():
    ...
    plot_summary(args.saliency_dir, args.output, dpi=args.dpi)
